...
import com.imissq.font.IcomoonIcon;
import com.imissq.font.IconicFontDrawable;
import com.imissq.utils.DeviceConfiger;
import com.imissq.utils.MaterialUtils;
import com.imissq.utils.MaterialUtils.Location;
...
public class AppMaterial {
    ...
    public static Drawable TAB_BAR_CORNER_STORKE_BG_LEFT(int normalColor, int selectColor, int cornorColor, int strokeW) {
        return MaterialUtils.createTabItemCornerBg(Location.LEFT, normalColor, selectColor, cornorColor, 40, 20,
                strokeW, true);
    }
    ...
    public static Drawable TAB_BAR_CORNER_STORKE_BG_RIGHT(int normalColor, int selectColor, int cornorColor, int strokeW) {
        return MaterialUtils.createTabItemCornerBg(Location.RIGHT, normalColor, selectColor, cornorColor, 40, 20,
                strokeW, true);
    }
    ...
    public static Drawable TAB_BAR_CORNER_BG_LEFT(int cornorColor) {
        return MaterialUtils.createTabItemCornerBg(Location.LEFT, Color.parseColor("#EBEBEB"), NUMBER_1_INT,
                cornorColor, 40, 20, 0, false);
    }
    ...
    public static Drawable TAB_BAR_CORNER_BG_CENTER(int cornorColor) {
        return MaterialUtils.createTabItemCornerBg(Location.CENTER, Color.parseColor("#EBEBEB"), NUMBER_1_INT,
                cornorColor, 40, 20, 0, false);
    }
    ...
    public static Drawable TAB_BAR_CORNER_BG_RIGHT(int cornorColor) {
        return MaterialUtils.createTabItemCornerBg(Location.RIGHT, Color.parseColor("#EBEBEB"), NUMBER_1_INT,
                cornorColor, 40, 20, 0, false);
    }
     ...
     * 实心圆角按钮背景指定状态颜色
     */
    public static Drawable BUTTON_BG_SOLID_CORNER(int nColor, int cColor) {
        return MaterialUtils.createCompleteSolidCornerBg(nColor, cColor);
    }

    /**
     * 实心圆角按钮背景
     */
    public static Drawable BUTTON_BG_SOLID_CORNER(int color) {
        return MaterialUtils.createSolidCornerBg(color);
    }
     ...
     * 空心圆角按钮背景
     */
    public static Drawable BUTTON_BG_SOLID_STROKE(int solidColor, int bodyColor, int selectedColor) {
        return MaterialUtils.createSolidStrokeBg(solidColor, bodyColor, selectedColor);
    }
    ...
    public static Drawable getStateDrawable(IcomoonIcon nomalIcon, int nomalColor, IcomoonIcon selectIcon,
        ...
        int pxW = DeviceConfiger.dp2px(w);
        int pxH = DeviceConfiger.dp2px(h);
        ...
        stateDrawable.setBounds(0, 0, pxW, pxH);
