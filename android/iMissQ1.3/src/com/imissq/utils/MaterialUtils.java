...
import com.imissq.views.DividerDrawable;
import com.imissq.views.DividerDrawable.DividerOrientation;

public class MaterialUtils {

    // /////////////////////////////////////////////////////////////////////

    // public static Drawable createMarkDrawble(Context context, int color) {
    // int w = DeviceConfiger.dp2px(15);
    // int h = DeviceConfiger.dp2px(15);
    // IconicFontDrawable normalDrawable = new IconicFontDrawable(context);
    // normalDrawable.setIcon(IconfontIcon.WEI_SHOU_CANG);
    // normalDrawable.setIconColor(color);
    // normalDrawable.setIntrinsicWidth(w);
    // normalDrawable.setIntrinsicHeight(h);
    // IconicFontDrawable selectDrawable = new IconicFontDrawable(context);
    // selectDrawable.setIcon(IconfontIcon.SHOU_CANG);
    // selectDrawable.setIconColor(Color.parseColor("#FFBA00")); // 黄色
    // selectDrawable.setIntrinsicWidth(w);
    // selectDrawable.setIntrinsicHeight(h);
    //
    // StateListDrawable stateDrawable = addStateDrawable(//
    // new int[] { android.R.attr.state_selected, android.R.attr.state_checked,
    // android.R.attr.state_pressed,
    // -1 },//
    // new Drawable[] { selectDrawable, selectDrawable, selectDrawable,
    // normalDrawable });
    ...
    // * @return
    // */
    // public static Drawable createCheckBoxDrawable(Context context, int color)
    // {
    // IconicFontDrawable normalDrawable = new IconicFontDrawable(context);
    // normalDrawable.setIcon(IconfontIcon.WEI_XUAN_ZHONG);
    // normalDrawable.setIconColor(color);
    // IconicFontDrawable selectDrawable = new IconicFontDrawable(context);
    // selectDrawable.setIcon(IconfontIcon.XUAN_ZHONG);
    // selectDrawable.setIconColor(color);
    //
    // Drawable stateDrawable = addStateDrawable(//
    // new int[] { android.R.attr.state_selected, android.R.attr.state_checked,
    // -1 },//
    ...
    // * @return
    // */
    // public static Drawable createTriangleCheckedDrawable(Context context, int
    // noramlColor, int selectColor) {
    // int w = DeviceConfiger.dp2px(8);
    // int h = DeviceConfiger.dp2px(13);
    // IconicFontDrawable normalDrawable = new IconicFontDrawable(context);
    // normalDrawable.setIcon(IconfontIcon.XIA_SAN_JIAO);
    // normalDrawable.setIconColor(noramlColor);
    // normalDrawable.setIntrinsicWidth(w);
    // normalDrawable.setIntrinsicHeight(h);
    // IconicFontDrawable selectDrawable = new IconicFontDrawable(context);
    // selectDrawable.setIcon(IconfontIcon.SHANG_SAN_JIAO);
    // selectDrawable.setIconColor(selectColor);
    // selectDrawable.setIntrinsicWidth(w);
    // selectDrawable.setIntrinsicHeight(h);
    // Drawable stateDrawable = addStateDrawable(//
    // new int[] { android.R.attr.state_selected, android.R.attr.state_checked,
    ...
    // * @return
    // */
    // public static Drawable createDownTriangleCheckedDrawable(Context context,
    // int noramlColor, int selectColor) {
    // int w = DeviceConfiger.dp2px(8);
    // int h = DeviceConfiger.dp2px(13);
    // IconicFontDrawable normalDrawable = new IconicFontDrawable(context);
    // normalDrawable.setIcon(IconfontIcon.XIA_SAN_JIAO);
    ...
    // normalDrawable.setIntrinsicHeight(h);
    // IconicFontDrawable selectDrawable = new IconicFontDrawable(context);
    // selectDrawable.setIcon(IconfontIcon.XIA_SAN_JIAO);
    // selectDrawable.setIconColor(selectColor);
    // selectDrawable.setIntrinsicWidth(w);
    // selectDrawable.setIntrinsicHeight(h);
    //
     ...
     * 创建带分割线输入框背景
     *
     * @param dividerColor      底部分割线颜色
     * @param hight             线的高度 px
     * @param conrnerLeftHight  左边拐角的高度
     * @param conrnerRightHight 右边拐角的高度
     * @return 背景图片Drawable
     */
    ...
    public static Drawable createInputBgFocusState(int dividerColor, int hight) {
        ...
        Drawable itemDrawable = addStateDrawable(new int[]{android.R.attr.state_focused,
                        android.R.attr.state_selected, -1}, //
     ...
     * @return
     */
    public static Drawable createCompleteSolidCornerBg(int nColor, int cColor) {
        int cornersRadius = DeviceConfiger.dp2px(5);
        // 默认
        GradientDrawable normalDrawable = new GradientDrawable();
        normalDrawable.setCornerRadius(cornersRadius);
        normalDrawable.setColor(nColor);

        // 选中 和默认一样
        GradientDrawable selectDrawable = new GradientDrawable();
        selectDrawable.setCornerRadius(cornersRadius);
        selectDrawable.setColor(cColor);
    ...
    public static Drawable createSolidCornerBg(int color) {
        ...
        disableDrawable.setCornerRadius(cornersRadius);
        disableDrawable.setColor(Color.parseColor("#C0D4DF"));

        Drawable itemDrawable = addStateDrawable(//
                new int[]{android.R.attr.state_selected, android.R.attr.state_pressed, -1}, //
                new Drawable[]{selectDrawable, selectDrawable, normalDrawable}, disableDrawable);
        return itemDrawable;
    }
     ...
     * @param bodyColor     按钮常态颜色
     * @param selectedColor 按钮按下颜色
     * @return
     */
    public static Drawable createSolidStrokeBg(int solidColor, int bodyColor, int selectedColor) {
        int cornersRadius = DeviceConfiger.dp2px(5);
        int strokeWidth = DeviceConfiger.dp2px(1);
        // 默认
        GradientDrawable normalDrawable = new GradientDrawable();
        ...
        // 选中
        GradientDrawable selectDrawable = new GradientDrawable();
        selectDrawable.setColor(selectedColor);
        selectDrawable.setCornerRadius(cornersRadius);
        Drawable itemDrawable = addStateDrawable(//
                new int[]{android.R.attr.state_selected, android.R.attr.state_checked, android.R.attr.state_pressed,
                        -1}, //
    ...
    public static Drawable createCornerBg(int normalColor, int paressColor, int cornerRadiusDp) {
        Log.d(Constants.TAG, "cornerRadiusDp:" + cornerRadiusDp);
     ...
     * @return StateListDrawable 返回类型
     */
    public static StateListDrawable addStateDrawable(int[] states, Drawable[] drawables, Drawable disableDrawable) {
        StateListDrawable sd = new StateListDrawable();
        Drawable normalDrawable = null;
        // 注意该处的顺序，只要有一个状态与之相配，背景就会被换掉
        // 所以不要把大范围放在前面了，如果sd.addState(new[]{},normal)放在第一个的话，就没有什么效果了
        ...
        sd.addState(new int[]{android.R.attr.state_enabled}, normalDrawable);
        //
        sd.addState(new int[]{}, disableDrawable);
        return sd;
    }
